<template>
    <section class="sillin">
        <header class="headerBox">
            <span @click="childClick"><i class="iconfont icon-guanbi2"></i></span>
            <h2 class="Title">疫苗信息</h2>
            <span @click="childClick"><i class="iconfont icon-dui"></i></span>
        </header>
        <main class="mainBox">
            <div class="inputBox">
                <!--时间组件-->
...
export default {
    ...
    methods:{
        childClick(){
            ...
            this.$emit('childValue',this.showName,this.version,this.timeIn)
        },
        timeValue(value){
            this.timeIn = value
        }
