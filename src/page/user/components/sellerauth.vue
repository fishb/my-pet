<template>
    <div class="Sellerauth">
        <header class="Sellerauthhead">
            <span><i class="iconfont icon-fanhui2" @click="history"></i></span>
            <h2 class="Title">商家认证</h2>
        </header>
        <main class="mainBox">
            <div class="inputBox">
            ...
            <div class="inputBox">
                ...
                <div class="inputfile">
                    <div class="upfile">
                        ...
                        <input type="file" accept="image/*" name="image" class="file" @change="update($event)">
                        </form>
                    </div>
                    <div class="example">
...
export default {
    ...
    methods:{
        ...
        become(){
            var that = this
            if(that.username==''||that.idnumber==''||that.f_img==''||that.s_img==''){
                ...
                var datas = {'username':that.username,'idnumber':that.idnumber,'f_img':that.f_img,'s_img':that.s_img}
        ...
        updates(e){
            ...
            .then(function(res){
                if(res.status == 200){
                   ...
                   _this.s_img = 'http://192.168.0.200:1015'+ res.data.src
                }    
            }) 
            .catch(function(error){
                _this.$dialog.toast({
