<template>
    ...
    <div class="fineBox">
        <header class="headerBox">
            ...
            <h2 class="Title">精品上架</h2>
        </header>
        <main class="mainBox">
            <!-- <div class="banner"><img src="../../assets/img/jpbanner.png" alt=""></div> -->
            <div class="finelist">
                <router-link :to="'/Substance/'+fine.id" v-for="fine in fineBox" :key="fine.id">
                    <div class="fineImg">
